...
export awsRDS= $awsRDS >> /etc/profile
source /etc/profile
...
nohup java $JAVA_OPTS $awsRDS -jar WebApplication-0.0.1-SNAPSHOT.jar > /home/ubuntu/output.log 2> /home/ubuntu/output.log < /home/ubuntu/output.log &
